...
THEMES: Dict[str, Theme] = {
    ...
    "xiaotie-light": Theme(
        ...
        info="#3b82f6",
        background="#ffffff",
        background_panel="#f8fafc",
        background_element="#f1f5f9",
        surface="#f8fafc",
        text="#1e293b",
        text_muted="#64748b",
        border="#e2e8f0",
        ...
        diff_added="#d1fae5",
        diff_removed="#fee2e2",
        markdown_heading="#4f46e5",
        markdown_link="#7c3aed",
        markdown_code="#16a34a",
        syntax_keyword="#7c2d12",
        syntax_function="#059669",
    ...
    "xiaotie-dark": Theme(
        ...
        text_muted="#94a3b8",
        border="#475569",
        border_active="#818cf8",
        border_subtle="#1e293b",
        diff_added="#34d399",
        diff_removed="#f87171",
        markdown_heading="#818cf8",
        markdown_link="#a78bfa",
        markdown_code="#34d399",
        syntax_keyword="#fca5a5",
